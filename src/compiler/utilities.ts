 ...
 * @internal
 */
export function setParent1<T extends Node>(child: T, parent: T["parent"] | undefined): T;
/** @internal */
export function setParent1<T extends Node>(child: T | undefined, parent: T["parent"] | undefined): T | undefined;
/** @internal */
export function setParent1<T extends Node>(child: T | undefined, parent: T["parent"] | undefined): T | undefined {
    return setParent(child as Mutable<T>, parent ) ;
}

/**
 * directly sets the `parent` property of a `Node`.
 *
 */
export function setParent<T extends MutableSyntacticNode>(child: T, parent: T["parent"] | undefined): T;
export function setParent<T extends MutableSyntacticNode>(child: T | undefined, parent: T["parent"] | undefined): T | undefined;
export function setParent<T extends MutableSyntacticNode>(child: T | undefined, parent: T["parent"] | undefined): T | undefined {
    if (child && parent) {
