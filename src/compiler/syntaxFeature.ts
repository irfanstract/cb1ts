...
export interface GrammaticalFeat01<Nd extends TS.Node & TS.SyntacticNode> extends
 ...
 * 
 */
export interface GrammaticalFeatSmAllAnalysOps01<Nd extends TS.Node>
 ...
 * 
 */
export abstract class GrammaticalParsingBuilder01<C extends S, S extends TS.Node = TS.SyntacticNode>
{
 ...
 * 
 */
export class GrammaticalParserDequeueingBuilder01<C extends S, S extends TS.Node = TS.SyntacticNode>
...
export abstract class GrammaticalPrinter01<C extends S, S extends TS.Node = TS.SyntacticNode>
{
  iGrammaticalPrinter01ObjBrand = Symbol()
}

export class GrammaticalStrfDefPrinter01<C extends S, S extends TS.Node = TS.SyntacticNode>
 ...
 * 
 */
export abstract class SyntacticTraverser01<C extends S, S extends TS.Node = TS.SyntacticNode>
 ...
 * 
 */
export class ArrayEnumerativeSyntacticTraverser01<C extends S, S extends TS.Node = TS.Node>
 ...
 * 
 */
export class ConditionalExprlikeSyntacticTraverser01<C extends S, S extends TS.Node>
 ...
 * 
 */
interface SyntacticTraverserNdb<S extends TS.Node> extends Object
{
  //
  iSyntacticTraverserNdbBrand ?: any ;
}

interface GCO<C extends S, S extends TS.Node> extends SyntacticTraverser01<C, S>, SyntacticTraverserNdb<S>
{
  //
  getChildrenOf(x: C) : { } ;
}
