 ...
 * 
 */
export interface FunctionallyGeneratedNode extends Node1
{
 ...
 * 
 */
export interface Expression extends ENode, PartialExpression, TermQuerylikeNode
{
...
/**
 * {@link Expression } is *proper*, *syntactic* *reference*, while
 * - {@link PartialExpression } is not necessarily *proper* (eg {@link OmittedExpression}, {@link SpreadElement} )
 * - {@link TermQuerylikeNode } is not necessarily *syntactic* (eg {@link FlowCondition} )
 * 
 */
export interface PartialExpression extends ENode, PartialTermQuerylikeNode
{
    _PartialExpressionBrand: any;
    readonly parent : ENode["parent"] ;
}

export interface OmittedExpression extends PartialExpression
{
...
export const enum TypeFlags {
     ...
     *    - {@link BooleanTypePredicativeType `x.y.z is T`         (returning `boolean`) } 
     *    - {@link AssertingVoidKwdType       `asserts x.y.z is T` (returning `void`   ) }
     *    - {@link SideEffectingVoidKwdType } (`void`)
     ...
     * - {@link PostConditionalReturnType    `(asserts x.y.z is CT ; Result )` (returning `Result`  )}
     */
 ...
 * - {@link BooleanTypePredicativeType } (`x.y.z is T` ; special sub-type(s) of `boolean` )
 * - {@link PostConditioningPredicate } (special sub-type(s) of `void`)
 *   - {@link AssertingTypePredicate } (`asserts z.y.z is T`)
 *   - {@link SideEffectingVoidKwdType } (`done { x() ; y(z) ; }`)
 * 
 */
...
export interface ParamTypePredicativeType extends TypePredicativeType { mainCond: TermTypePredicate ; }
 ...
 * 
 */
export interface AssertingVoidKwdType extends TypePredicativeType, PostConditioningVoidKwdType, UnconditionalFlowDirectingType
{
    mainCond: AssertingTypePredicate ;
}

/**
 * {@link PostConditioningVoidKwdType} for {@link HasDoneSomethingTypePredicate } 
 */
export interface SideEffectingVoidKwdType extends PostConditioningVoidKwdType
{ mainCond: HasDoneSomethingTypePredicate }
 ...
 * by switching to {@link PostConditionalReturnType} since they {@link PostConditionalReturnType.mainThreadType reference this } ;
 * 
 * ideally type-checker(s) should reject snippets using this directly as types of `const`s or *parameter*s ;
 * this *type* should only occur directly
 * as return-type(s) (eg in `(x: number ) => asserts x is Integer `), or
 ...
 * 
 */
export interface PostConditioningVoidKwdType extends TypePredicativeType, UnconditionalFlowDirectingType
{
 ...
 * 
 */
export interface PostConditionalReturnType extends Type, InstantiableType, UnconditionalFlowDirectingType
{
    //
 ...
 * ```
 * 
 * subclassed by {@link PostConditioningVoidKwdType} and {@link PostConditionalReturnType}.
 * 
 * ideally type-checker(s) should reject snippets using this directly as types of `const`s or *parameter*s ;
 * this *type* should only occur directly
 * as return-type(s) (eg in `(x: number ) => asserts x is Integer `), or
 ...
 * 
 */
export interface UnconditionalFlowDirectingType extends Type, InstantiableType
{
    //
}

export type FlowAnalyticsSpecificType =
    | UnconditionalFlowDirectingType
    | TypePredicativeType
;
