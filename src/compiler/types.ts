...
export interface HasDoneSomethingTypePredicate extends TypePredicateBase
{
...
export enum TypeFlags {
     ...
     * - 
     * - {@link VARIANT3_OR_VOID} & {@link PATHDEPENDENT_OR_INTERPOLATIVE} --> {@link PostConditioningType `asserts x is T`}
 ...
 * 
 */
export interface PostConditioningType extends TypePredicativeType
{
...
export interface PostConditionalReturnType extends Type {
    //
    mainThreadType: PostConditioningType ;
    returnType: Type ;
}
...
extends TypeCheckerAssociatedMaybe
{
     ...
     * ```
     * 
     * use - as {@link resolvedReturnType } - {@link PostConditioningType}
     * 
     * @internal
     * @deprecated
     * 
    ...
    /**
     * optional pre-condition, as {@link PostConditioningType}
     * 
     * @see {@link PostConditioningType}
     */
    resolvedPreCondition ?: PostConditioningType ;
    /** @internal */
